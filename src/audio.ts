import { GenerateAudioFile, TextFile, ESpeakExecutionError, ESpeakOptions } from './types';
...
export const generateAudioFile: GenerateAudioFile = async (
    ...
    try {
        ...
        throw new Error('espeak is not installed or not available in the system PATH');
    }
    ...
    try {
        ...
        throw new ESpeakExecutionError(`Failed to generate audio file: ${(error as Error).message}`);
    }
};